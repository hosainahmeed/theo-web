        ...
        <div className="grid md:grid-cols-2 md:gap-10 lg:gap-20 max-w-7xl w-full items-center">
          ...
          <div className="p-5">
            ...
            <form>
              ...
              <button type="submit" className="w-full py-3.5 bg-[#0088FF] text-white rounded-lg text-sm cursor-pointer transition-all hover:-translate-y-0.5 hover:shadow-[0_10px_20px_rgba(99,102,241,0.3)]" >
                Send message
              </button>
            </form>
          </div>
